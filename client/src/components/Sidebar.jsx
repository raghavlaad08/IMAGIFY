    ...
    >
      ...
      <div className='flex items-center gap-2 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md '>
        ...
        <label className='relative inline-flex cursor-pointer'>
          ...
          <span className='absolute left-1 top-1 w-3 h-3 bg-white rounded-full transiton-transform peer-checked:translate-x-4'>
          </span>
        </label>
      </div>
      {/* User Account */}
      <div className='flex items-center gap-3 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md cursor-pointer group '>
        <img src={assets.gallery_icon} className='w-7 rounded-full' alt="" />
